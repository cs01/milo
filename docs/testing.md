...
Add a test by dropping a `.milo` file in the right directory with the right annotation. That's it. (<!-- stat:fixtures -->618<!-- /stat --> fixtures, <!-- stat:error-fixtures -->256<!-- /stat --> error cases, <!-- stat:runtime-error-fixtures -->20<!-- /stat --> runtime-error cases.)
