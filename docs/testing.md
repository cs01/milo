...
Add a test by dropping a `.milo` file in the right directory with the right annotation. That's it. (<!-- stat:fixtures -->664<!-- /stat --> fixtures, <!-- stat:error-fixtures -->294<!-- /stat --> error cases, <!-- stat:runtime-error-fixtures -->27<!-- /stat --> runtime-error cases.)
