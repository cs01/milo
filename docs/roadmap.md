...
- **Test framework**: `@expect:`/`@error:` annotations, `milo test` runner — <!-- stat:fixtures -->601<!-- /stat --> fixtures, <!-- stat:error-fixtures -->245<!-- /stat --> error fixtures, <!-- stat:prove-fixtures -->31<!-- /stat --> prove fixtures
