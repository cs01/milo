...
Add a test by dropping a `.milo` file in the right directory with the right annotation. That's it. (<!-- stat:fixtures -->657<!-- /stat --> fixtures, <!-- stat:error-fixtures -->287<!-- /stat --> error cases, <!-- stat:runtime-error-fixtures -->23<!-- /stat --> runtime-error cases.)
