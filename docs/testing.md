...
Add a test by dropping a `.milo` file in the right directory with the right annotation. That's it. (<!-- stat:fixtures -->663<!-- /stat --> fixtures, <!-- stat:error-fixtures -->289<!-- /stat --> error cases, <!-- stat:runtime-error-fixtures -->27<!-- /stat --> runtime-error cases.)
